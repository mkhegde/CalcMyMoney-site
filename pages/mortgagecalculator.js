...
import { PoundSterling, Home, Calculator, TrendingUp, Percent, Heart, Key, AlertTriangle } from "lucide-react";
...
const mortgageCalculatorFAQs = [
  ...
  },
  {
    ...
    answer: "Stamp duty is a tax on property purchases in England and Wales. For 2025/26, you pay 5% on the portion between £250k-£925k, 10% on £925k-£1.5m, and 12% above £1.5m. First-time buyers get relief up to £425k."
  },
  {
  ...
  },
  {
    ...
    answer: "Beyond the deposit and stamp duty, budget for: legal fees (£1,000-£2,000), survey costs (£400-£1,200), mortgage arrangement fees (£0-£2,000), buildings insurance, and moving costs. Allow 3-5% of purchase price for total costs."
  }
];
...
export default function MortgageCalculator() {
  ...
  const handleCalculate = () => { // Renamed from calculateMortgage
    ...
    if (currentPropertyValue > 925000) {
      stampDuty += Math.min(currentPropertyValue - 925000, 1500000 - 925000) * 0.10;
    }
  ...
  return (
    <>
      <script type="application/ld+json">
        {JSON.stringify(mortgageCalculatorJsonLd)}
      </script>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              UK Mortgage Calculator 2025/26 | Free Property Finance Tool
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Calculate UK mortgage payments, affordability, and stamp duty costs. Free mortgage calculator for England, Wales, Scotland & Northern Ireland property purchases.
            </p>
            <div className="mt-6 text-sm text-gray-500 dark:text-gray-400 max-w-4xl mx-auto">
                <p>Includes stamp duty calculator • Affordability assessment • Interest-only & repayment mortgages • Updated 2025/26 rates</p>
              </div>
          </div>
        </div>
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      value={propertyValue}
                      onChange={(e) => setPropertyValue(e.target.value)} // Changed to e.target.value
                      className="pl-10"
                      placeholder="e.g. 300000" // Updated placeholder
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      value={deposit}
                      onChange={(e) => setDeposit(e.target.value)} // Changed to e.target.value
                      className="pl-10"
                      placeholder="e.g. 60000" // Updated placeholder
                    />
                  </div>
                  <p className="text-xs text-gray-500 h-4"> {/* Added h-4 for consistent height */}
                    {propertyValue && deposit && Number(propertyValue) > 0 ? `${((Number(deposit) / Number(propertyValue)) * 100).toFixed(1)}% of property value` : ''}
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      value={interestRate}
                      onChange={(e) => setInterestRate(e.target.value)} // Changed to e.target.value
                      className="pl-10"
                      step="0.1"
                      placeholder="e.g. 4.5" // Updated placeholder
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      value={income}
                      onChange={(e) => setIncome(e.target.value)} // Changed to e.target.value
                      className="pl-10"
                      placeholder="e.g. 50000" // Updated placeholder
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setMonthlyExpenses(e.target.value)} // Changed to e.target.value
                      className="pl-10"
                      placeholder="e.g. 1500" // Updated placeholder
                    />
                  </div>
                </div>
            ...
            {hasCalculated && results ? ( // Conditionally render results
              <>
                <div className="flex justify-between items-center non-printable">
                  ...
                  <ExportActions csvData={csvData} fileName="mortgage-calculation" title="Mortgage Calculation" />
                </div>
                {/* Summary Cards */}
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-green-900">
                            £{results.loanAmount?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}
                          </p>
                        </div>
                ...
                <Card id="affordability-assessment" className={`${results.affordabilityRatio > 45 ? 'bg-red-50 dark:bg-red-900/30 border-red-200 dark:border-red-700' : results.affordabilityRatio > 35 ? 'bg-yellow-50 dark:bg-yellow-900/30 border-yellow-200 dark:border-yellow-700' : 'bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-700'}`}>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <TrendingUp className="w-5 h-5" />
                      Affordability Assessment
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">£{(income / 12).toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Monthly Expenses:</span>
                          <span className="font-semibold">-£{monthlyExpenses.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Mortgage Payment:</span>
                          <span className="font-semibold">-£{results.monthlyPayment?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                        </div>
                        <div className="flex justify-between border-t pt-2">
                          <span>Remaining:</span>
                          <span className={`font-bold ${results.disposableIncome - results.monthlyPayment >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                            £{(results.disposableIncome - results.monthlyPayment)?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className={`font-semibold ${results.affordabilityRatio > 45 ? 'text-red-600' : results.affordabilityRatio > 35 ? 'text-yellow-600' : 'text-green-600'}`}>
                            {results.affordabilityRatio?.toFixed(1)}%
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Max Affordable Loan:</span>
                          <span className="font-semibold">£{results.maxAffordableMortgage?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Current Loan Amount:</span>
                          <span className={`font-semibold ${results.loanAmount > results.maxAffordableMortgage ? 'text-red-600' : 'text-green-600'}`}>
                            £{results.loanAmount?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}
                          </span>
                        </div>
                        ...
                        {results.affordabilityRatio > 45 && (
                          <div className="p-3 bg-red-100 rounded-lg mt-3">
                            <p className="text-sm text-red-800">
                              ⚠️ Payment ratio exceeds recommended 45% - consider a lower loan amount
                            </p>
                          </div>
                        )}
                ...
                {/* Cost Breakdown */}
                <Card id="cost-breakdown" className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                  <CardHeader>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span>£{Number(deposit).toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span> {/* Use Number(deposit) for display */}
                            </div>
                            <div className="flex justify-between">
                              <span>Stamp Duty:</span>
                              <span>£{results.stampDuty?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                            <div className="flex justify-between">
                            ...
                            <div className="flex justify-between border-t pt-2 font-semibold">
                              ...
                              <span>£{results.totalUpfrontCosts?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span>£{results.loanAmount?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Total Interest:</span>
                              <span>£{results.totalInterest?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                            <div className="flex justify-between">
                              <span>Monthly Payment:</span>
                              <span>£{results.monthlyPayment?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                            ...
                            <div className="flex justify-between border-t pt-2 font-semibold">
                              ...
                              <span>£{results.totalPayable?.toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <Card className="bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700">
                  ...
                  <CardContent className="text-sm text-blue-800">
                    <ul className="space-y-2">
                      <li>🏠 <strong>Stamp Duty:</strong> Calculated for England & Wales. Scotland and Northern Ireland have different rates.</li>
                      <li>📊 <strong>LTV Ratio:</strong> Lower ratios typically qualify for better interest rates</li>
                      <li>💰 <strong>Affordability:</strong> Lenders typically offer 4-4.5x annual income, subject to affordability tests</li>
                      <li>📈 <strong>Interest Only:</strong> Remember you'll still owe the full loan amount at the end of the term</li>
                      <li>⚖️ <strong>Additional Costs:</strong> Consider buildings insurance, mortgage protection, and ongoing maintenance</li>
                      <li>📞 <strong>Professional Advice:</strong> Consult a mortgage advisor for personalized recommendations</li>
                    </ul>
                  </CardContent>
                </Card>
              </>
              ...
              <Card className="lg:col-span-2 flex items-center justify-center h-[400px] bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <div className="text-center text-gray-500">
                  ...
                  {hasCalculated && !results && ( // Display error message if calculation was attempted but results are null
                    <p className="text-red-500 mt-2">Please ensure all required fields are filled and valid (e.g., property value, deposit, interest rate, term, and loan amount is positive).</p>
                  )}
                </div>
              </Card>
            )}
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 py-12 non-printable">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Complete UK Mortgage & Property Calculator</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 text-sm text-gray-700">
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Mortgage Calculations</h3>
              <ul className="space-y-2">
                <li>• Monthly payment calculator</li>
                <li>• Total interest costs</li>
                <li>• Repayment vs interest-only</li>
                <li>• Loan-to-value ratios</li>
                <li>• Early repayment scenarios</li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Affordability Check</h3>
              <ul className="space-y-2">
                <li>• Income multiplier assessment</li>
                <li>• Debt-to-income ratios</li>
                <li>• Stress testing at higher rates</li>
                <li>• Joint applicant calculations</li>
                <li>• Additional income sources</li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">UK Property Costs</h3>
              <ul className="space-y-2">
                <li>• Stamp duty calculator (England/Wales)</li>
                <li>• Legal and survey fees</li>
                <li>• First-time buyer relief</li>
                <li>• Additional property surcharge</li>
                <li>• Total upfront cost breakdown</li>
              </ul>
            </div>
          </div>
        </div>
